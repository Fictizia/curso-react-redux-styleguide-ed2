...
const Title = (props) => {
  return <h3 className="Card__title">{props.text}</h3>
}

const SubTitle = (props) => {
  return <h5 className="Card__subtitle">{props.text}</h5>
}

const Paragraph = (props) => {
  return <p className="Card__paragraph">{props.text}</p>
}

const Image = (props) => {
  return <img src={props.srcImage} className="Card__image"/>
}
  ...
  render() {
    return (
      <aside className="Card">
        <Image srcImage={this.props.scrImage} />
